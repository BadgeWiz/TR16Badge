...
"""
A Trooper's desire to show a message on his badge can be statisfied in the 
following manner:
>>> python2 rf_trooper.py --msg "Bitcon miner activated"
...
badge's side.  You can use the cmd to show those. Checkout the help text
...
def parse_args():
    ...
    parser.add_argument("--msg", type=str, nargs=1, help="Arbitrary messages, up to 28 chars allowed.")
    ...
    if a.msg:
        ...
        # Null bytes are appended at the badge in any way. But sometimes garbadge
